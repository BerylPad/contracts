...
///      the security review. Membership/scope changes are owner-only.
contract B20PolicyOrchestrator {
    ...
    ///         fees accrue and the pool bricks permanently. So
    ...
    ///      fee-path infra is ALWAYS folded in so a compliant pool
